...
class Agent(ComponentBase):
    ...
    def execute(self, input_object: InputObject, agent_input: dict) -> dict:
        ...
        # component_type=<ComponentEnum.PLANNER: 'PLANNER'> component_config_path='/root/Documents/agentUniverse/agentuniverse/agent/plan/planner/peer_planner/peer_planner.yaml' default_symbol=False name='peer_planner' description='peer planner' output_key='output' input_key='input' prompt_assemble_order=['introduction', 'target', 'instruction']
        # agent_model: /root/Documents/agentUniverse/sample_standard_app/app/core/agent/peer_agent_case/demo_peer_agent.yaml内的所有文本
